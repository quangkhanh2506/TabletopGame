    ...
    public class GameManager : MonoBehaviourPunCallbacks
    {
        ...
        [SerializeField] private GameObject PositionResetPlayer1;
        [SerializeField] private GameObject PositionResetPlayer2;
        ...
        public List<GameObject> lsFinishPlayer = new List<GameObject>();
                    ...
                    if (gameMode==GameMode.Offline ||(PhotonNetwork.IsMasterClient && TurnManager.instance.turn % 2 == 1) || (!PhotonNetwork.IsMasterClient && TurnManager.instance.turn % 2 == 0))
                    {
                        ...
                        if (Physics.Raycast(ray, out hit))
                        {
                            if (hit.collider.gameObject.name == "Dice001")
                            {
                                CanMouseDown = false;
                                CountDown = 10;
                                photonView.RPC("SetAllCanMouseDownFalse", RpcTarget.All);
        ...
        [PunRPC]
        public void SetAllCanMouseDownFalse()
        {
            CanMouseDown = false;
            CountDown = 10;
        }
